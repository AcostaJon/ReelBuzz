...
export async function GET() {
    ...
    try {
        ...
        // get top rated tv shows and return data to res variable
        const res = await fetch('https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=1', options).then((data) => {
            return data.json();
        })
